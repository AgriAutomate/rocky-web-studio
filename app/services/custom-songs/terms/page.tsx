    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white py-16">
      <div className="container max-w-4xl mx-auto px-4">
        ...
        <div className="mb-12">
          ...
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              ...
              <p className="text-slate-500">Custom AI Songs Service</p>
            </div>
          </div>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-8 space-y-8">
          ...
          <section>
            <h2 className="text-xl font-semibold text-slate-900 mb-3">3. Production & Delivery</h2>
            <p className="text-slate-600 mb-3">
          ...
          {/* 4. Revisions */}
          <section>
            <h2 className="text-xl font-semibold text-slate-900 mb-3">4. Revisions Policy</h2>
            <p className="text-slate-600 mb-3">
            ...
            <p className="text-slate-600 mt-3">Major changes (e.g., complete style overhaul, new subject matter) may require a new order.</p>
          </section>

          {/* 5. Intellectual Property */}
          <section>
            <h2 className="text-xl font-semibold text-slate-900 mb-3">5. Intellectual Property & Licensing</h2>
            <p className="text-slate-600 mb-3">
          ...
          {/* 6. Refunds */}
          <section>
            <h2 className="text-xl font-semibold text-slate-900 mb-3">6. Refund Policy</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-slate-900 mb-3">7. Content Guidelines</h2>
            <p className="text-slate-600 mb-3">We reserve the right to decline orders containing:</p>
            <ul className="list-disc list-inside text-slate-600 space-y-1">
          ...
          {/* 10. Privacy */}
          <section>
            <h2 className="text-xl font-semibold text-slate-900 mb-3">10. Privacy & Data</h2>
            <p className="text-slate-600">
          ...
          <section>
            ...
            <p className="text-slate-600">
              ...
              <a href="mailto:hello@rockywebstudio.com.au" className="text-teal-600 hover:underline">
