 ...
 * 
 * Pricing and timelines are pulled from centralized pricing configuration
 */
export const RWS_SERVICES: KnowledgeBaseService[] = [
  {
    ...
    pricing: SERVICE_PRICING['website-design-development'].pricingRange,
    timeline: SERVICE_PRICING['website-design-development'].timeline,
  ...
  },
  {
    ...
    pricing: SERVICE_PRICING['website-redesign-refresh'].pricingRange,
    timeline: SERVICE_PRICING['website-redesign-refresh'].timeline,
  ...
  },
  {
    ...
    pricing: SERVICE_PRICING['ecommerce'].pricingRange,
    timeline: SERVICE_PRICING['ecommerce'].timeline,
  ...
  },
  {
    ...
    pricing: SERVICE_PRICING['seo-performance'].pricingRange,
    timeline: SERVICE_PRICING['seo-performance'].timeline,
  ...
  },
  {
    ...
    pricing: SERVICE_PRICING['ai-automation'].pricingRange,
    timeline: SERVICE_PRICING['ai-automation'].timeline,
  ...
  },
  {
    ...
    pricing: SERVICE_PRICING['healthcare-systems'].pricingRange,
    timeline: SERVICE_PRICING['healthcare-systems'].timeline,
    technologies: ['Healthcare', 'HIPAA Compliance', 'Patient Portals']
  },
  {
    name: 'Accessibility Audits',
    description: 'WCAG 2.1 AA compliance audits and remediation',
    pricing: SERVICE_PRICING['accessibility-audits'].pricingRange,
    timeline: SERVICE_PRICING['accessibility-audits'].timeline,
  ...
  },
  {
    ...
    pricing: SERVICE_PRICING['crm-integration'].pricingRange,
    timeline: SERVICE_PRICING['crm-integration'].timeline,
