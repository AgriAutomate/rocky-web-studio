# n8n Direct Startup Script (Non-Docker)
# Sets required environment variables and starts n8n directly
# Use this if you installed n8n via npm: npm install -g n8n

Write-Host "========================================" -ForegroundColor Cyan
Write-Host "  n8n Startup Script (Direct)" -ForegroundColor Cyan
