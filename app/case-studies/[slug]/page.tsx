              ...
              <div className="case-study-content">
                {(() => {
                  ...
                  if (typeof caseStudy.content === 'string') {
                    markdownContent = caseStudy.content;
                  } else if (typeof caseStudy.content === 'object' && caseStudy.content !== null) {
                    // Handle object format: { type: "markdown", content: "..." }
                    if ('content' in caseStudy.content && typeof caseStudy.content.content === 'string') {
                      markdownContent = caseStudy.content.content;
                    } else {
                      // Fallback: try to extract any string value
                      const contentStr = JSON.stringify(caseStudy.content);
