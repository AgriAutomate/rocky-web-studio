...
export function AdminCaseStudyForm({
  ...
  const [formData, setFormData] = useState<CaseStudyCreate>({
    ...
    before_metrics: undefined,
    after_metrics: undefined,
    hero_image_url: "",
    images: undefined,
    testimonial_text: "",
    testimonial_author: "",
  ...
  useEffect(() => {
    if (caseStudy) {
      setFormData({
        ...
        published_at: caseStudy.published_at || undefined,
        before_metrics: caseStudy.before_metrics || undefined,
        after_metrics: caseStudy.after_metrics || undefined,
        hero_image_url: caseStudy.hero_image_url || "",
        images: caseStudy.images || undefined,
