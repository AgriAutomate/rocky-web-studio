      ...
      <div className="mx-auto max-w-6xl space-y-6 px-4">
        <section className="rounded-3xl border border-border bg-card p-6 shadow">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-2xl font-semibold text-foreground">SMS Activity</h1>
              <p className="text-sm text-muted-foreground">Monitor confirmations and reminders.</p>
            </div>
                ...
                {loading ? (
                  ...
                  filteredLogs.map((log) => (
                    <tr key={log.id} className="hover:bg-muted">
                      ...
                      <td className="px-3 py-2 text-xs font-mono text-muted-foreground">{log.customRef || "—"}</td>
